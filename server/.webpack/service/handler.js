...
`;e.exports=r},function(e,t,n){const o=n(5),r=new o.DynamoDB.DocumentClient;new o.DynamoDB;const{promisify:i}=n(6),d=new o.SSM,a={Name:"/api/tableone",WithDecryption:!1},u=i(d.getParameter).bind(d),l=async()=>{const{Parameter:e}=await u(a);console.log("parameters",e);const t={TableName:e.Value},n=i(r.scan).bind(r);return(await n(t)).Items},s=async({id:e,userId:t,description:n})=>{const{Parameter:o}=await u(a);console.log("description",n);const d=(()=>{let e=new Date;const t=`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`,n=String(e.getDate()).padStart(2,"0");return`${String(e.getMonth()+1).padStart(2,"0")}/${n}/${e.getFullYear()} ${t}`})(),l={TableName:o.Value,Item:{id:e,userId:t,completed:!1,createdOn:d,description:n}},s=i(r.put).bind(r);return await s(l)},c={Query:{getTodos:()=>l()},Mutation:{addTodo:(e,{input:t})=>(s(t),l()),deleteTodo:(e,{input:t})=>(console.log("input",t),(async({id:e,userId:t})=>{console.log("id",e);const{Parameter:n}=await u(a),o={TableName:n.Value,Key:{id:e,userId:t}};console.log("params",o);const d=i(r.delete).bind(r),l=await d(o);console.log("deleteTodo",l)})(t),t.id)}};e.exports=c},function(e,t){e.exports=require("aws-sdk")},function(e,t){e.exports=require("util")}]);
